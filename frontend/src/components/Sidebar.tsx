...
export default function Sidebar({
        ...
        >
          <motion.div
            className={clsx(
              ...
              isActive
                ? 'bg-[rgba(255,184,107,0.10)] border-l-2 border-accent-cyan text-accent-cyan shadow-lg shadow-accent-cyan/10'
                : clsx(
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="p-4 border-t border-[rgba(255,255,255,0.08)]"
